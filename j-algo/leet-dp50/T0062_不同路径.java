 ...
 */
public class T0062_不同路径 {
    public static void main(String[] args) {
        T0062_不同路径 t = new T0062_不同路径();
        assertEquals(28, t.uniquePaths(3, 7));
        assertEquals(28, t.uniquePaths1(3, 7));
        assertEquals(3, t.uniquePaths(3, 2));
        assertEquals(3, t.uniquePaths1(3, 2));
        assertEquals(6, t.uniquePaths(3, 3));
        assertEquals(6, t.uniquePaths1(3, 3));
        assertEquals(1916797311, t.uniquePaths(51, 9));
        assertEquals(1916797311, t.uniquePaths1(51, 9));
        assertEquals(1, t.uniquePaths(1, 100));
        assertEquals(1, t.uniquePaths1(1, 100));
    }
